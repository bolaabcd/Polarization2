...
good_bf.graph.add_edges_from(all_edges([0], r1), inf = 1, tol = tolv, upf = f1)
good_bf.graph.add_edges_from(all_edges([lpos], r3), inf = 1, tol = tolv, upf = f1)
good_bf.graph.add_edges_from(all_edges(r1, r2), inf = 1, tol = tolv, upf = f1)
good_bf.graph.add_edges_from(all_edges(r3, r2), inf = 1, tol = tolv, upf = f1)
good_bf.graph.add_edges_from(all_edges(r2, r1), inf = 1, tol = tolv, upf = f1)
good_bf.graph.add_edges_from(all_edges(r2, r3), inf = 1, tol = tolv, upf = f1)
