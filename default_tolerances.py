...
def build_tol_graph_constant(num_agents,tolerance_value):
    return [tolerance_value for i in range(num_agents)]

def build_tol_graph_random(num_agents):
...
def build_tol_graph(
    ...
    if tol_type is Tolerance.CONSTANT:
        ...
        return build_tol_graph_constant(num_agents, tolerance_value)
    if tol_type is Tolerance.RANDOM:
        return build_tol_graph_random(num_agents)
